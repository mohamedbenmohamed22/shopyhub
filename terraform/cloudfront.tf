...
# Lets CloudFront sign requests to the private frontend bucket.
...
resource "aws_cloudfront_distribution" "main" {
  ...
  # --- Origin 2: NestJS API on EC2 (same HTTPS domain, no CORS/mixed content) ---
  origin {
    origin_id   = "ec2-api"
  ...
  # API traffic -> EC2 origin, uncached, all headers/methods forwarded.
